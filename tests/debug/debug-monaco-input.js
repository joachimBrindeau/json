...
async function debugMonacoInput() {
  ...
  try {
    ...
    const finalState = await page.evaluate(() => {
      ...
      const chevronButtons = document.querySelectorAll('svg.lucide-chevron-right, svg.lucide-chevron-down');
      ...
      return {
        ...
        hasTreeContent: document.querySelector('[data-tree]') || document.querySelector('[role="tree"]') ? true : false
      };
    });
