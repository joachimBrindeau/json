...
test.describe('JSON Expand/Collapse Functionality', () => {
  ...
  test('should expand and show child elements correctly', async ({ page }) => {
    ...
    const userNodeExpandBtn = page
      .locator('[data-testid="json-node"]:has-text("user:") button')
      .first();
    ...
    const profileExpandBtn = page
      .locator('[data-testid="json-node"]:has-text("profile:") button')
      .first();
    ...
    const hobbiesExpandBtn = page
      .locator('[data-testid="json-node"]:has-text("hobbies:") button')
      .first();
  ...
  test('should handle nested arrays correctly', async ({ page }) => {
    ...
    // Expand posts array
    const postsExpandBtn = page
      .locator('[data-testid="json-node"]:has-text("posts:") button')
      .first();
    ...
    // Expand first post
    const firstPostExpandBtn = page
      .locator('[data-testid="json-node"]:has-text("[0]:") button')
      .first();
    ...
    const tagsExpandBtn = page
      .locator('[data-testid="json-node"]:has-text("tags:") button')
      .first();
