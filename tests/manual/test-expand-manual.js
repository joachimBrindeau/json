...
async function testExpandCollapse() {
  ...
  try {
    ...
    try {
      await page.waitForSelector('button[data-testid="tree-view"], button:has-text("Tree")', { timeout: 5000 });
    ...
    const expandButtons = await page.$$('button svg.lucide-chevron-right, button svg.lucide-chevron-down');
