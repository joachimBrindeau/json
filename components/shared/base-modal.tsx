...
export const ConfirmationModal = forwardRef<BaseModalRef, Omit<BaseModalProps, 'variant'> & {
...
export const SuccessModal = forwardRef<BaseModalRef, Omit<BaseModalProps, 'variant'>>((props, ref) => (
  <BaseModal
    ref={ref}
    {...props}
    variant="success"
